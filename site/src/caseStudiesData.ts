...
export const caseStudies: CaseStudy[] = [
  {
    ...
    approachSteps: [
      ...
      {
        label: "4. Never let the cover letter do the employer's screening for them.",
      ...
      {
        label: "5. Match voice, not just content.",
        text: "I keep a short reference doc describing how I actually write: plain openings, no corporate phrasing, no em dashes, short sentences. Every letter is held to that profile instead of a generic \"warm and professional\" default. The profile itself has been revised twice, both times because a draft got flagged for slipping into a dramatic opening or AI-typical phrasing, and each fix got written back into the profile so it wouldn't recur. The bigger change came later: full drafts written by AI kept scoring high on AI detectors no matter how they were reworded, so now the skill hands me a short brief (the company hook, the proof points that fit the persona, the format) and I write the letter myself. Its job shifts to review: typos, facts against the resume, and anything a hiring manager could misread, while keeping my words."
      }
    ],
    approachClosing:
