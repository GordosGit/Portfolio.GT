      ...
      <main id="top">
        <section className="hero section">
          <div className="hero-copy">
            ...
            <motion.div initial="hidden" animate="visible" variants={fadeUp} className="hero-name">
              Gord Turner
            </motion.div>
            ...
            <motion.p initial="hidden" animate="visible" variants={fadeUp} className="hero-text">
              A Senior Product Owner and Business Analyst building practical AI tools that formalize the analytical work behind good product decisions.
            </motion.p>
